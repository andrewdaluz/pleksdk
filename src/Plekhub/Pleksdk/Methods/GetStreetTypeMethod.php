...
/**
 * Description of GetStreetTypeMethod
 *
 * @author cleomar
 */
class GetStreetTypeMethod extends AMethod {
    protected $endpoint = "resource/street-type";
    /**
     * 
    ...
    public function execute() {
        ...
        if($objectResponse && $objectResponse->status == "success"){
            $data = $objectResponse->data->street_type;
            $return = [];
