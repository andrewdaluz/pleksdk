...
/**
 * Description of GetPropertyTypeMethod
 *
 * @author cleomar
 */
class GetPropertyTypeMethod extends AMethod {
    protected $endpoint = "resource/property-type";
    /**
     * 
    ...
    public function execute() {
        ...
        if($objectResponse && $objectResponse->status == "success"){
            $data = $objectResponse->data->property_type;
            $return = [];
