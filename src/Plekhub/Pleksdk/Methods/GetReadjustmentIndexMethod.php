...
/**
 * Description of GetReadjustmentIndexMethod
 *
 * @author cleomar
 */
class GetReadjustmentIndexMethod extends AMethod {
    protected $endpoint = "resource/readjustment-index";
    /**
     * 
    ...
    public function execute() {
        ...
        if($objectResponse && $objectResponse->status == "success"){
            $data = $objectResponse->data->readjustment_index;
            $return = [];
